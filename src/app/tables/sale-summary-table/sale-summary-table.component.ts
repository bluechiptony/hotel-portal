...
@Component({
  selector: 'app-sale-summary-table',
  templateUrl: './sale-summary-table.component.html',
  styleUrls: ['./sale-summary-table.component.scss'],
})
export class SaleSummaryTableComponent implements OnInit {
  tableColumns: string[] = [
    'userCode',
    'fullName',
    'emailAddress',

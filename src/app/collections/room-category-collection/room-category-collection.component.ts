...
@Component({
  selector: 'app-room-category-collection',
  templateUrl: './room-category-collection.component.html',
  styleUrls: ['./room-category-collection.component.scss'],
})
export class RoomCategoryCollectionComponent implements OnInit {
